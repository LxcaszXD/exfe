<form method="POST" action="<?= BASE_URL ?>pedido/adicionar" enctype="multipart/form-data">
                ...
                <div class="card">
                    <div class="card-header pb-0">
                        <div class="d-flex align-items-center">
                            <p class="mb-0">Adicionar Pedido</p>
                        </div>
                    </div>

                    <div class="card-body">
                        <p class="text-uppercase text-sm">Informações dos Pedidos</p>
                        <div class="row">
                            <!-- Nome completo -->
                            <div class="col-md-6">
