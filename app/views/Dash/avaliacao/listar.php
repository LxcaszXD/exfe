...
<div class="container my-5">
            ...
            <tbody>
                ...
                <?php foreach ($avaliacoes as $linha): ?>
                    <tr class="fw-semibold">
                        ...
                        <td>
                            <a href="<?= BASE_URL ?>avaliacao/editar/<?php echo $linha['id_avaliacao']; ?>" title="Editar">
    ...
    <div class="text-center mt-4">
        ...
        <a href="<?= BASE_URL ?>avaliacao/adicionar/" class="btn fw-bold px-4 py-2" style="background:#5e3c2d; color: #ffffff; border-radius: 8px;">
            Adicionar Avaliação
        </a>
    </div>
</div>
...
<script>
    ...
    function excluirAvaliacao(idAvaliacao) {
        fetch(`<?= BASE_URL ?>avaliacao/excluir/${idAvaliacao}`, {
            method: 'POST',
            headers: {
