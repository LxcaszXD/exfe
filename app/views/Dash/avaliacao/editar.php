...
<form method="POST" action="<?= BASE_URL ?>avaliacao/editar/<?php echo $avaliacao['id_avaliacao']; ?>">
    ...
    <div class="row justify-content-center">
      <div class="col-12 col-md-8">
        ...
        <div class="card shadow-lg border-0 rounded-4 p-4" style="background: #ffffff;">
          <h4 class="fw-bold mb-4 text-center" style="color: #5e3c2d;">Editar Avaliação</h4>
          ...
          <div class="mb-3">
            ...
            <select class="form-select" id="id_produto" name="id_produto" required style="color: #5e3c2d;">
              ...
              <?php foreach ($produto as $linha): ?>
                <option value="<?php echo $linha['id_produto']; ?>" <?php echo $linha['id_produto'] == $avaliacao['id_produto'] ? 'selected' : ''; ?>>
          ...
          <div class="mb-3">
            ...
            <select class="form-select" id="nota" name="nota" required style="color: #5e3c2d;">
              ...
              <?php for ($i = 1; $i <= 5; $i++): ?>
                <option value="<?php echo $i; ?>" <?php echo $i == $avaliacao['nota'] ? 'selected' : ''; ?>>
          ...
          <div class="mb-3">
            ...
            <textarea class="form-control" id="comentario" name="comentario" rows="4" placeholder="Deixe seu comentário aqui..." required style="color: #5e3c2d;"><?php echo $avaliacao['comentario']; ?></textarea>
          </div>
          ...
          <div class="mt-4 text-center d-grid gap-2 d-md-flex justify-content-md-center">
            ...
            <a href="<?= BASE_URL ?>avaliacao/listar/<?php echo $avaliacao['id_cliente']; ?>" class="btn btn-lg px-5" style="background: #5e3c2d; color: white; font-weight: bold; border-radius: 12px;">Cancelar</a>
          </div>
        </div>
